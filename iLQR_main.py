...
def discrete_dynamics(x, u):
    ...
    #  forward Euler method for numerical integration of a first-order discrete-time system.
    # car_continuous_dynamics(x, u) is x_dot
...
def rollout(x0, u_trj):
    ...
    for n in range((u_trj.shape[0])):
        x_trj[n+1] = discrete_dynamics(x_trj[n], u_trj[n])
    return x_trj
...
# print(u_trj)
# print(x_trj)
# print(discrete_dynamics(0, 1))
# print(discrete_dynamics(0.1, 1))
...
def forward_pass(x_trj, u_trj, k_trj, K_trj):
    ...
    for n in range(u_trj.shape[0]):
        ...
        # x_trj_new[n+1, :] = car_continuous_dynamics(x_trj_new[n, :], u_trj_new[n, :])
        # or discrete?
...
def backward_pass(x_trj, u_trj, regu):
    ...
    derivs = derivatives(discrete_dynamics, cost_stage, cost_final, x_trj.shape[1], u_trj.shape[1])
